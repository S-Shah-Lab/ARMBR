function [segmented_data] = Segment(data_vector, fs, window_size, shift_size)
% [segmented_data] = MaxAmp(data_vector, fs, window_size, shift_size)
%
% Inputs:
...
%
% Outputs:
%    segmented_data is a cell of `M` window_size second long data segments
...
for i = 1:shift_size_pts+1:length(data_vector)
    ...
    segmented_data = [segmented_data {window_data}];
end
